...
* [`src/clj/profile_app/`](src/clj/profile_app/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/profile_app/`](src/cljs/profile_app/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/profile_app/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `profile-app` project root directory
...
in the [`src/clj/profile_app/`](src/clj/profile_app/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/profile_app/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns profile-app.example
  (:require [profile-app.config :as config])
